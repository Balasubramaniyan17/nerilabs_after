...
def get_effective_base_url(request: Request) -> str:
    ...
    if host and not host.startswith("localhost") and not host.startswith("127.0."):
        # Enforce https for production public URLs to prevent browser mixed content blocks on HTTPS client sites
