...
class Config:
    ADMIN_MASTER_KEY: str = os.getenv("NERILABS_ADMIN_KEY", "nerilabs_admin_master_2026_founder")
    DESIGN_PARTNER_KEYS = [f"nerilabs_design_partner_{i}" for i in range(1, 11)]
    # Networking & Domain
    APP_BASE_URL: str = os.getenv("APP_BASE_URL", "https://app.nerilabs.io")
    ...
    DEFAULT_API_KEY: str = "nerilabs_sk_live_9a8b7c6d5e4f3a2b1c"
    DEFAULT_PUBLISHABLE_KEY: str = "nerilabs_pk_live_9a8b7c6d5e4f3a2b1c"
    ...
    # Platform Subscription Stripe Price IDs (from Stripe Dashboard > Products > Pricing)
    STRIPE_PRICE_STARTER: str = os.getenv("STRIPE_PRICE_STARTER", "")
    STRIPE_PRICE_GROWTH: str = os.getenv("STRIPE_PRICE_GROWTH", "")
    STRIPE_PRICE_SCALE: str = os.getenv("STRIPE_PRICE_SCALE", "")

    # Platform Subscription Direct Stripe Payment Links (Optional direct checkout URLs)
    STRIPE_PAYMENT_LINK_STARTER: str = os.getenv("STRIPE_PAYMENT_LINK_STARTER", "")
    STRIPE_PAYMENT_LINK_GROWTH: str = os.getenv("STRIPE_PAYMENT_LINK_GROWTH", "")
    STRIPE_PAYMENT_LINK_SCALE: str = os.getenv("STRIPE_PAYMENT_LINK_SCALE", "")
